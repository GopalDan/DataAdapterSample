...
public class LongListActivity extends Activity {
    ...
    private static final String ROW_LENGTH = "ROW_LENGTH";
    ...
    public void onCreate(Bundle bundle) {
        ...
        String[] from = new String[]{ROW_TEXT, ROW_LENGTH, ROW_ENABLED};
        int[] to = new int[]{R.id.rowContentTextView,R.id.rowContentTextSize, R.id.rowToggleButton};
    ...
    protected static Map<String, Object> makeItem(int forRow) {
        ...
        String text = String.format(ITEM_TEXT_FORMAT, forRow);
        dataRow.put(ROW_TEXT, text);
        dataRow.put(ROW_LENGTH, text.length());
